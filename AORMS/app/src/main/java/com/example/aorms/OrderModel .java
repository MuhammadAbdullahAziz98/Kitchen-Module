...
public class OrderModel {
    ...
    public OrderModel(int order_id, Timestamp ordertime, String status, int table_id, Timestamp order_prep_time, float bill, List<OrderDishInfoModel> orderPlaced) {
