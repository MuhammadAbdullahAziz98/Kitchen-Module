...
public class DifferentQueueChangeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                moveOrder(oldChefPosition-1,newChefPosition-1,oldQueuePosition,newQueuePosition);
    ...
    {
    //get chefs
        Toast.makeText(getApplicationContext(),chefArrayList.get(oldChefPosition).getName(),Toast.LENGTH_LONG).show();
...
//        chefArrayList.get(oldChefPosition).chefOrderQueues.remove(oldChefPosition);
        ...
        oldChefPosition = oldChefPosition+1;
        newChefPosition = newChefPosition+1;
        String newChef = Integer.toString(newChefPosition);
        String oldChef = Integer.toString(oldChefPosition);
        firebaseDatabase.getReference().getRoot().child("Chef").child(newChef).child("chefOrderQueues").child(Integer.toString(newQueuePosition)).setValue(chefOrderQueue).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
      ...
      String oldPos = Integer.toString(oldQueuePosition);
        firebaseDatabase.getReference().getRoot().child("Chef").child(oldChef).child("chefOrderQueues").child(Integer.toString(oldQueuePosition)).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
